...
{
	arr_for_convert[0] = HAL_GPIO_ReadPin(JOYBTN_RIGHT_GPIO_Port, JOYBTN_RIGHT_Pin);
	arr_for_convert[1] = HAL_GPIO_ReadPin(JOYBTN_LEFT_GPIO_Port, JOYBTN_LEFT_Pin);
	arr_for_convert[2] = HAL_GPIO_ReadPin(BTN_LEFT_GPIO_Port, BTN_LEFT_Pin);
	arr_for_convert[3] = HAL_GPIO_ReadPin(BTN_RIGHT_GPIO_Port, BTN_RIGHT_Pin);
	
	joybtn_right_state = arr_for_convert[0];
	joybtn_left_state = arr_for_convert[1];
	btn_left_state = arr_for_convert[2];
	btn_right_state = arr_for_convert[3];
